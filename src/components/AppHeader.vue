<template>
  <div class="bg-blue-400 shadow-md shadow-gray-400/80">
      <div class="max-w-7xl mx-auto flex justify-between items-center py-5 px-2 md:px-4">
          <div>
        ...
        <nav class="text-white ">
            <ul class="flex gap-7">
                ...
                <div class="flex gap-2 justify-center items-center">
                    <img alt="User's Image" src="../assets/logo.png" class="w-12 aspect-square rounded-full"/>
