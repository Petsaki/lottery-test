        ...
        <nav class="text-white">
            <ul class="flex gap-7 flex-wrap-reverse justify-end">
                <div class="flex gap-3 justify-center items-center flex-wrap">
                    <li >
                    <router-link to="/"  class="font-semibold bg-blue-700 rounded-md px-2 py-[6px] h-min  whitespace-nowrap">Home</router-link>
                    </li>
                    <li>
                    <button @click="goAtDraw" class="font-semibold bg-blue-700  rounded-md px-2 py-[6px] h-min whitespace-nowrap text leading-[21px]">Live Draw</button>
                    </li>
                    <li>
                    <router-link  to="/history" class="font-semibold bg-blue-700 rounded-md px-2 py-[6px] h-min ">History</router-link>
                    </li>
                </div>
